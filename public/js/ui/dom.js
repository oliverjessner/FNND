...
export const dom = Object.freeze({
    ...
    settings: Object.freeze({
        ...
        bullshitForm: byId('bullshit-rule-form'), bullshitName: byId('bullshit-rule-name'), bullshitField: byId('bullshit-rule-field'),
        bullshitOperator: byId('bullshit-rule-operator'), bullshitValue: byId('bullshit-rule-value'), bullshitEnabled: byId('bullshit-rule-enabled'),
        bullshitSubmit: byId('bullshit-rule-submit'), bullshitCancel: byId('bullshit-rule-cancel'), bullshitFormStatus: byId('bullshit-rule-form-status'),
        bullshitState: byId('bullshit-rules-state'), bullshitList: byId('bullshit-rules-list'),
        bullshitReevaluate: byId('bullshit-rules-reevaluate'), bullshitReevaluateStatus: byId('bullshit-rules-reevaluate-status'),
